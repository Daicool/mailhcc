...
def checkhotmail():
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print (" \033[1;31m➻❥ |\033[1;37mHChong\033[1;31m|Email Live|" + hot_mail + "@hotmail.com")
      open(hotmail_live,'a').write(hot_mail + "@hotmail.com" + "\n")
    else:
      print (" \033[1;32m➻❥ |\033[1;37mHChong\033[1;32m|Email Die|" + hot_mail + "@hotmail.com")
...
def checkyahoo():
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print(" \033[1;32m➻❥ |\033[1;37mHChong\033[1;32m|Mail Die| " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print(" \033[1;31m➻❥ |\033[1;37mHChong\033[1;31m|Mail Live| " + yid + "@yahoo.com")
...
def checkvalid():
  print ('')
  print ('             \033[1;34m[ FB Trần Hiếu Trọng  ]')
  print ('')
  try:
    ...
    print (" \033[1;31mKHÔNG TÌM THẤY FILE VỪA ĐÃ NHẬP !")
    quit()
  list_email_fb = []
  ...
  def run_check_valid(emailfb):
    ...
    if kq_check == None:
      print (" \033[1;32m➻❥ |\033[1;37mHChong\033[1;32m| Có Liên Kết |" + emailfb)
      open(valid,"a").write(emailfb + "\n")
    else:
      print (" \033[1;31m➻❥ |\033[1;37mHChong\033[1;31m| Không Liên Kết |" + emailfb)
  with concurrent.futures.ThreadPoolExecutor() as executor:
...
def logo():
  logo = """
                  \033[0;33m➻❥ Tool By : Trần Hiếu Trọng (HChong)
                  \033[1;31m➻❥ Donate: MBBank, Momo: 0354500378
